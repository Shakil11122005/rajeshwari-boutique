...
import aariWork1 from '../assets/aari-work-1.jpeg';
import aariWork2 from '../assets/aari-work-2.jpeg';
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center bg-teal-dark p-12 text-cream rounded-3xl shadow-2xl overflow-hidden relative">
          ...
          <div className="grid grid-cols-2 gap-6 relative z-10">
            <img src="https://drive.google.com/file/d/19t2WHuWSwowmHGdXx4eFWvmQDSiXKs-b/view?usp=drivesdk" alt="Bridal Aari Work" className="w-full h-56 object-cover rounded-2xl border-2 border-gold/20 shadow-xl" />
            <img src="https://drive.google.com/file/d/19t2WHuWSwowmHGdXx4eFWvmQDSiXKs-b/view?usp=drivesdk"  alt="Bridal Aari Detail" className="w-full h-56 object-cover rounded-2xl border-2 border-gold/20 shadow-xl" />
          </div>
        </div>
      </div>
    </div>
